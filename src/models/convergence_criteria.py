...
class ConvergenceState:
    ...
    def update(self, n_epoch, all_losses, output_probabilities, target_probabilities):
...
class ConvergenceCriteria:
    ...
    def update_state(self, epochs, all_losses, output_probabilities, target_probabilities):
        self.state.update(epochs, all_losses, output_probabilities, target_probabilities)
...
class ConvergenceCriterion:
    ...
    #     return self.__hasConverged(*args, **kwargs)
